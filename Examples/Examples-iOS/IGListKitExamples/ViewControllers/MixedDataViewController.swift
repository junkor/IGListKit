...
final class MixedDataViewController: UIViewController, ListAdapterDataSource, ListAdapterMoveDelegate {
    ...
    let collectionView = UICollectionView(frame: .zero, collectionViewLayout: WBStreamCollectionViewLayout.init(stickyHeaders: false, scrollDirection: .vertical, topContentInset: 10, stretchToEdge: true))
